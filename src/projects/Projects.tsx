...
const projects: {
  ...
  {
    id: "yourdash",
    displayName: "YourDash (deprecated)",
    description:
                ...
                <>
                  ...
                  {project.links.download && (
                    <Button
                      onClick={() => {
                        window.location.href =
                          project.links.download || "/projects";
                      }}
                      text={"Download"}
                    />
                  )}
            ...
            >
              <section className={styles.header}>
                <Image
                  ...
                  src={project.iconUrl || "/plainLogo.png"}
                  accessibleLabel="Project Icon"
                />
                <Heading
